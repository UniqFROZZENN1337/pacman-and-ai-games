...
Asset = ' 12'[randrange(0, 3)].strip()
BoardPath = "assets/BoardImages/"
ElementPath = "assets/" + Asset + "ElementImages/"
...
spriteRatio = 3/2
square = 22 # Size of each unit square
spriteOffset = square * (1 - spriteRatio) * (1/2)
(width, height) = (len(gameBoard[0]) * square, len(gameBoard) * square) # Game screen
screen = pygame.display.set_mode((width, height))
pygame.display.set_caption("Plasm-Pacman")
pygame.display.set_icon(pygame.image.load(r'Media/logo.png'))
pygame.display.flip()
...
class Game:
    ...
    def displayScore(self):
        textOneUp = ["tile033.png", "tile021.png", "tile016.png"]  #current account redo
...
def displayLaunchScreen():
    ...
    # Credit myself
    credit = ["tile015.png", "tile015.png", "tile015.png", "tile016.png", "tile011.png", "tile000.png", "tile019.png", "tile012.png", "tile043.png", "tile011.png", "tile004.png", "tile000.png", "tile005.png"]
